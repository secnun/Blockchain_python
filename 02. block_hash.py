...
block2 =  {'INDEX':1,
           ...
           'previous_block' : hashlib.sha256(str(block1).encode()).hexdigest()
          }
...
block4 =  {'INDEX':4,
           ...
           'previous_block' : hashlib.sha256(str(block3).encode()).hexdigest()
          }
...
block5 =  {'INDEX':5,
           ...
           'previous_block' : hashlib.sha256(str(block4).encode()).hexdigest()
          }
